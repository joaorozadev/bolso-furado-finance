"""
=========================================================
BOLSO FURADO - VERSÃO 1.2 (LEGADO CLI)
=========================================================
Aviso: Este script é mantido apenas como histórico do projeto. 
Ele foi construído na primeira fase do desenvolvimento e não é 
mais compatível com a arquitetura atual do banco de dados (SaaS Multi-usuário).
As funções de terminal e exportação foram migradas para a API REST (Flask).
=========================================================
"""
